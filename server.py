...
class AppDB:
    ...
    def search(self, query: str):
        ...
        # Hits stack, so a post with the word in BOTH title and description scores 5.
        post_relevance = (
        ...
        # Users: prioritize exact first/last name matches over partial ones.
        user_relevance = (
        ...
        # Categories: exact match first, then partial.
        cat_relevance = (
